...
const tercerPaso = () => console.log("03-finde mi programa");
/*
primerPaso();
segundoPaso();
tercerPaso();
...
const saludoAsincrono = (name) => {
    setTimeout(()=>console.log(name) , 3000  ) // expresado en milisegundos
}
primerPaso();
...
//setInterval()
//Ejecuta una funcion de manera reiteerada con un timepo de retardo fijo
const saludos = ["Hola", "Que tranza", "konnichiwua", "ciao", "hallo", "hej", "bonjour", "olá"];
