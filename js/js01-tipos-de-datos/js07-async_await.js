...
const getPersonajes = async(url) => {
    ...
    console.log ("termia mi asyn-await");
}
getPersonajes( "https://rickandmortyapi.com/api/character/?page=10" );
...
const setUp = async ()=>{
        ...
        try{
            await getPersonajes( "https://.com/api/character/?page=10" );    
        } catch( exception ){
