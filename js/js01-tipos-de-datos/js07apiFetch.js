...
/*
Solicitud de personas usando la apiFetch
con then() y catch ()
*/
...
*/
const getSopita = (url)=>{
    //then y catch son metodos para manejar promesas
    //promesa es un valor que puede estar presente en cualquer momento
